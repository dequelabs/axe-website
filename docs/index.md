...
2. [Section 2: API Reference](#section-2-api-reference)
	...
	6. [API Name: axe.run](#api-name-axerun)
		...
		2. [Context Parameter](#context-parameter)
		3. [Options Parameter](#options-parameter)
		4. [Callback Parameter](#callback-parameter)
			1. [Return Promise](#return-promise)
			2. [Error result](#error-result)
			3. [Results Object](#results-object)
	7. [API Name: axe.registerPlugin](#api-name-axeregisterplugin)
	8. [API Name: axe.cleanup](#api-name-axecleanup)
	9. [API Name: axe.a11yCheck](#api-name-axea11ycheck)
